module por_dig (force_dis_rc_osc,
 ...
 sky130_fd_sc_hd__nor2_1 _077_ (.A(net4),
    .B(net21),
    .Y(_039_));
 sky130_fd_sc_hd__nand2_1 _078_ (.A(\cnt_st[0] ),
    .B(_039_),
    .Y(_000_));
 ...
 sky130_fd_sc_hd__a21o_1 _085_ (.A1(_042_),
    ...
    .B1(_030_),
    .X(_044_));
 sky130_fd_sc_hd__o21a_1 _086_ (.A1(\cnt_st[4] ),
    .A2(_032_),
    .B1(_044_),
    .X(_003_));
 sky130_fd_sc_hd__o21a_1 _087_ (.A1(\cnt_st[4] ),
    ...
    .B1(_032_),
    .X(_045_));
 sky130_fd_sc_hd__a21bo_1 _088_ (.A1(\cnt_st[4] ),
    .A2(_042_),
    .B1_N(_045_),
    .X(_004_));
 ...
 sky130_fd_sc_hd__o211a_1 _116_ (.A1(net4),
    ...
    .C1(\cnt_por[8] ),
    .X(_027_));
 sky130_fd_sc_hd__xnor2_1 _117_ (.A(\cnt_por[8] ),
    .B(_026_),
    .Y(_013_));
 sky130_fd_sc_hd__o2111a_1 _118_ (.A1(net4),
    ...
    .D1(\cnt_por[9] ),
    .X(_028_));
 sky130_fd_sc_hd__xor2_1 _119_ (.A(\cnt_por[9] ),
    .B(_027_),
    .X(_014_));
 sky130_fd_sc_hd__xor2_1 _120_ (.A(\cnt_por[10] ),
    .B(_028_),
    .X(_015_));
 ...
 sky130_fd_sc_hd__dfrtp_1 _125_ (.CLK(osc_ck),
    ...
    .RESET_B(net25),
    .Q(\cnt_st[4] ));
 sky130_fd_sc_hd__dfrtp_4 _126_ (.CLK(osc_ck),
    .D(_005_),
    .RESET_B(net24),
    .Q(\cnt_por[0] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _131_ (.CLK(osc_ck),
    ...
    .RESET_B(net24),
    .Q(\cnt_por[5] ));
 sky130_fd_sc_hd__dfrtp_1 _132_ (.CLK(osc_ck),
    .D(_011_),
    .RESET_B(net24),
    .Q(\cnt_por[6] ));
 sky130_fd_sc_hd__dfrtp_1 _133_ (.CLK(osc_ck),
    .D(_012_),
    .RESET_B(net24),
    .Q(\cnt_por[7] ));
 sky130_fd_sc_hd__dfrtp_1 _134_ (.CLK(osc_ck),
    .D(_013_),
    .RESET_B(net24),
    .Q(\cnt_por[8] ));
 sky130_fd_sc_hd__dfrtp_1 _135_ (.CLK(osc_ck),
    .D(_014_),
    .RESET_B(net25),
    .Q(\cnt_por[9] ));
 sky130_fd_sc_hd__dfrtp_1 _136_ (.CLK(osc_ck),
    .D(_015_),
    .RESET_B(net25),
    .Q(\cnt_por[10] ));
 sky130_fd_sc_hd__dfrtp_1 _137_ (.CLK(osc_ck),
    .D(net26),
    .RESET_B(net8),
    .Q(cnt_rsb_stg1));
 sky130_fd_sc_hd__dfrtp_1 _138_ (.CLK(osc_ck),
    .D(cnt_rsb_stg1),
    .RESET_B(net8),
    .Q(cnt_rsb));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout24 (.A(cnt_rsb),
    .X(net24));
 sky130_fd_sc_hd__clkbuf_2 fanout25 (.A(cnt_rsb),
    .X(net25));
