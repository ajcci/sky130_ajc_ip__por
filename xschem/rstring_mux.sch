...
spiceprefix=X
mult=1}
C {devices/ipin.sym} -390 -1090 2 1 {name=p34 lab=avdd}
C {devices/ipin.sym} -230 1220 2 1 {name=p35 lab=avss}
...
C {devices/ipin.sym} 610 -580 2 1 {name=p3 lab=ena}
C {devices/lab_pin.sym} 690 -580 2 0 {name=p4 sig_type=std_logic lab=ena_b}
...
C {devices/lab_pin.sym} -320 -1090 1 1 {name=p8 sig_type=std_logic lab=avdd}
C {devices/lab_pin.sym} -280 -1150 2 0 {name=p9 sig_type=std_logic lab=ena_b}
C {devices/lab_pin.sym} -160 1090 2 0 {name=p1 sig_type=std_logic lab=ena_b}
