...
C {devices/ipin.sym} -430 -280 2 1 {name=p8 lab=force_rc_osc}
...
C {devices/lab_pin.sym} -150 -40 0 0 {name=p17 lab=force_pdnb}
...
C {devices/lab_pin.sym} 150 -60 0 1 {name=p23 lab=pwup_filt}
C {devices/lab_pin.sym} 150 -40 0 1 {name=p24 lab=osc_ck}
C {devices/lab_pin.sym} -150 80 0 0 {name=p25 lab=osc_ena}
C {devices/lab_pin.sym} 150 -20 0 1 {name=p26 lab=porb_h}
C {devices/lab_pin.sym} -150 100 0 0 {name=p27 lab=por_unbuf}
C {devices/lab_pin.sym} 150 0 0 1 {name=p28 lab=por}
C {devices/lab_pin.sym} 150 20 0 1 {name=p29 lab=porb}
