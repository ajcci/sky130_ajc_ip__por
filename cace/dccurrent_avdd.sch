...
Description: Power-on-reset DC current CACE testbench} -1200 -70 0 0 0.4 0.4 {}
N -210 -610 -200 -610 {
lab=avdd_bg}
N -200 -660 -200 -610 {
lab=avdd_bg}
...
C {devices/vsource.sym} 0 -440 0 0 {name=Vena value="DC [\{force_pdn\}*\{Vdvdd\}]" savecurrent=false}
...
.save all
"}
C {devices/code_shown.sym} -1210 -400 0 0 {name=CONTROL only_toplevel=false value=".control
op
set wr_singlescale
...
C {devices/lab_pin.sym} 300 -100 0 1 {name=p12 lab=por_timed_out}
C {devices/lab_pin.sym} 300 -160 0 1 {name=p13 lab=pwup_filt}
C {devices/lab_pin.sym} 300 -200 0 1 {name=p16 lab=dcomp}
...
C {devices/lab_wire.sym} 450 -280 0 0 {name=p21 sig_type=std_logic lab=porb_h}
...
footprint=1206
device="ceramic capacitor"}
C {devices/lab_wire.sym} 450 -260 0 0 {name=p27 sig_type=std_logic lab=porb}
C {devices/lab_wire.sym} 450 -240 0 0 {name=p28 sig_type=std_logic lab=por}
C {devices/lab_pin.sym} 0 -160 0 0 {name=p8 lab=force_pdn}
