...
C {devices/vsource.sym} 640 -680 0 0 {name=Vavdd value="pwl (0 0 2m 3.3 3m 3.3 3.0001m 2 3.2m 2 3.2001m 3.3) DC \{Vavdd\}" savecurrent=true}
...
"}
C {devices/code_shown.sym} -1200 -310 0 0 {name=CONTROL only_toplevel=false value=".control
tran 10u 4m
set wr_singlescale
